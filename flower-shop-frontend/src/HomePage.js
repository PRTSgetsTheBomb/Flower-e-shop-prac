...
import FadeInUp from './components/Generic/FadeInUp';
import HeadBanner from './components/Homepages/HeadBanner';
import FeaturedProducts from './components/Homepages/FeaturedProducts';
import Favorite from './components/Homepages/LocalLoved';
import OccasionCategory from './components/Homepages/OccasionCategory';
import LocalFlorist from './components/Homepages/LocalFlorist';
import DeliveryArea from './components/Homepages/DeliveryArea';
import AboutArrange from './components/Homepages/AboutArrange';
import WeddingArrange from './components/Homepages/WeddingArrange';
import Feedback from './components/Homepages/Feedback';
import Questions from './components/Homepages/Questions';
import FootBanner from './components/Homepages/FootBanner';

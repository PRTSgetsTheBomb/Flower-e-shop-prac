 ...
 * 博客文章详情页（/blogs/:slug�?
 *
 * 核心职责：根�?slug 获取并展示单篇文章完整内�?
 *
 * 设计说明�?
 * - �?ProductDetail 相同的三态渲染模式：loading �?not found �?内容
 * - useParams 获取 URL 中的 slug，useEffect 依赖 [slug] 实现路由变化时重新请�?
 * - 文章内容�?dangerouslySetInnerHTML 渲染（WP API 返回 HTML 格式�?
 * - 底部提供"返回博客列表"链接
 */

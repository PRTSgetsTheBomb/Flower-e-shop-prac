 ...
 *
 * 核心职责：展示所有服务区域的导航链接
 * - 数据驱动渲染：从 Generic/Areas 导入地名列表，动态生成链�?
 * - 每个地名自动转为 slug 指向 /delivery/:slug
 * - Prahran 单独作为一个特殊区域链�?
 * - 与首�?DeliveryArea 组件共用同一份数据源，增删地名只需修改 Areas.js
 */
...
import '../../styles/DeliveryAreaPage.css';

// 将地名转�?URL slug（如 "St Kilda" �?"st-kilda"�?Melbourne CBD" �?"melbourne-cbd"�?
